...
function InitiateWidgets() {
	$('.page-body ').delegate('.widget-buttons [data-toggle="maximize"]', "click",function (event) {
	...
	$('.page-body ').delegate('.widget-buttons [data-toggle="collapse"]', "click",function (event) {
		event.preventDefault();
		var widget = $(this).parents(".widget").eq(0);
	...
	$('.page-body').delegate('.widget-buttons [data-toggle="dispose"]', "click",function (event) {
		event.preventDefault();
